...
public class RamSnakeGame extends NonBlockingGame{
    ...
    public RamSnakeGame(int assid, String login, String apiKey, int r, int c){
        ...
        setTitle("Ram Snake Game");
        setDescription("Name: Nahome Kifle; Course number: cmsc256-901 ; Section: 2 create a \"Snake\" (a line of sprites that moves along a 2D grid)  that can be moved around using upArrow, downArrow, rightArrow, and leftArrow keys.");
    ...
    public static void main(String args[]) {
        ...
        RamSnakeGame  mg = new RamSnakeGame(ASSIGNMENT_NUMBER, "Nahome1212", "485728358356", boardSize[0], boardSize[1]);
    }
    public void initialize() {
        ...
        for (int i = 0; i < boardSize[0]; ++i){
            for (int j = 0; j < boardSize[1]; ++j) {
                ...
                drawSymbol(i, j,NamedSymbol.none,NamedColor.green);
            }}
    ...
    private void draw() {
        ...
        setBGColor(lastPos[0],lastPos[1],NamedColor.green );
        // Use the lastPos array

        // Use a loop to tranverse the Snake arraylist and
        // draw the snake on all the tiles
        for(int i = 0; i < snake.size(); i++){
    setBGColor(snake.get(i)[0],snake.get(i)[1],NamedColor.blue);
        }
        //draw in the apple using an apple symbol
        drawSymbol(apple[0],apple[1], NamedSymbol.apple, NamedColor.chocolate );
    }
    private void changeDirection(String newDirection) {
        ...
        // set the String oppositeDirection to the opposite of that directionString oppositeDirection;
